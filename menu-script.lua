...
frame.Size = UDim2.new(0, 300, 0, 200)  -- Ukuran frame (lebar: 300, tinggi: 200)
frame.Position = UDim2.new(0.5, -150, 0.5, -100)  -- Posisi di tengah layar
...
button1.Position = UDim2.new(0.1, 0, 0.3, 0)  -- Posisi di dalam frame
...
button2.Position = UDim2.new(0.1, 0, 0.6, 0)  -- Posisi di dalam frame
